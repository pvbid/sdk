...
test("get options", () => {
  const expected = [{ row_id: "mhzk", title: "Module 1" }, { row_id: "be6f", title: "Module 2" }];
...
describe("Datatable with linked inventory", () => {
  ...
  test("get column values", () => {
    const expected = [{ id: "6nq6", value: "1000" }, { id: "w0wb", value: "" }, { id: "3t2n", value: "" }];
  ...
  test("get cell values", () => {
    ...
    expect(linkedDatatable.getValue("pvlink_pvbid_part_name", "6nq6")).toBe(
      "Test Manufacturer - Test Module I"
    );
